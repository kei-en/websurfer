...
export async function CategoriesForm() {
  ...
  return (
    <section className="md:w-[95%] lg:w-5/6 h-5/6 mx-auto mt-8 mb-0 md:my-8 border border-slate-700 bg-slate-300 dark:bg-slate-950 rounded-md rounded-b-none md:rounded-lg p-4">
      <div className="my-8 lg:m-8 w-fit">
        ...
        <form action={getCategories}>
          <button className="flex w-3/4 md:w-1/3 lg:w-1/4 justify-center items-center text-white mx-auto mt-16 md:mt-20 p-4 rounded-lg bg-sky-700 hover:bg-sky-600 cursor-pointer">
        ...
        <p className="text-sm m-4 text-slate-900 dark:text-gray-200">
