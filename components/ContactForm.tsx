...
export function ContactForm() {
  return (
    <div className="w-[95%] lg:w-5/6 mx-auto border border-slate-800 mb-2 md:mb-4 rounded-md md:rounded-lg p-4 pt-2 px-10 md:p-8 md:pt-4 md:px-16 shadow-input bg-slate-950 opacity-95">
