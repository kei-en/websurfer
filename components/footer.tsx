  ...
  return (
    <AuroraBackground>
      <svg
        ...
        className="absolute -top-20 lg:-top-32 h-28 text-slate-100 dark:text-slate-900 lg:h-40 xl:h-48">
        <path
      ...
      <motion.div
        ...
        <div className="text-3xl md:text-3xl font-bold text-slate-950 dark:text-white text-center inline-flex gap-2">
          <Image
            src={"/ws-logo.png"}
            alt="websurfer logo"
            width={61}
        ...
        <div className="font-extralight text-base text-neutral-950 dark:text-neutral-200 py-4">
          <span className="font-semibold text-lg md:text-xl">About</span>
          <ul>
            <li className="py-2 hover:text-sky-700 dark:hover:text-sky-400 underline">
      ...
      <motion.div
        ...
        className="text-slate-900 dark:text-slate-400 text-xs absolute bottom-10">
        <span>
          &#169; {date.getFullYear()} Websurfer and{" "}
          <a
            href="https://www.k7n.tech"
            target="_blank"
            className="text-neutral-900 dark:text-cyan-50 hover:text-sky-800 dark:hover:text-sky-400">
            Kei eN
          </a>
        </span>
      </motion.div>
