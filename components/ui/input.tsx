    ...
    return (
      ...
      `,
        ...
        <input
          type={type}
          className={cn(
            `flex h-10 w-full border-none bg-slate-800 dark:bg-slate-800 text-white dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
